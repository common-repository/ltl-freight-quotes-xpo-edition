jQuery(document).ready(function () {
    ...
    jQuery(".disabled_me").on('dblclick', function () {
        return false;
    });
 ...
 * @return {undefined}
 */
if (typeof xpo_load_inside_pikup_and_local_delivery_data != 'function')
{
    function xpo_load_inside_pikup_and_local_delivery_data(data, formID)
    {
 ...
 * @returns {Boolean}
 */
if (typeof xpo_en_wd_save_warehouse != 'function')
{
    function xpo_en_wd_save_warehouse()
    {
        ...
        var postForm = {
            'action': 'xpo_en_wd_save_warehouse',
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return xpo_en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_xpo_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
 ...
 * @returns {Boolean}
 */
if (typeof en_xpo_wd_delete_current_warehouse != 'function')
{
    function en_xpo_wd_delete_current_warehouse(e)
    {
        var tab = get_parameter_by_name('tab');
        var postForm = {
            'action': 'xpo_en_wd_delete_warehouse',
            'delete_id': e,
            'tab': tab,
        };
 ...
 * @returns {Boolean}
 */
if (typeof xpo_en_wd_edit_warehouse != 'function')
{
    function xpo_en_wd_edit_warehouse(e)
    {
        var postForm = {
            'action': 'xpo_en_wd_edit_warehouse',
            'edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data)
            {
                if (data[0]) {
                    ...
                    window.location.href = jQuery('.xpo_en_wd_add_warehouse_btn').attr('href');
                    ...
                    xpo_load_inside_pikup_and_local_delivery_data(data, "#add_warehouses");
                }
            },
        });
        return false;
 ...
 * @returns {Boolean}
 */
if (typeof xpo_en_wd_save_dropship != 'function')
{
    function xpo_en_wd_save_dropship()
    {
        ...
        var postForm = {
            'action': 'xpo_en_wd_save_dropship',
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return xpo_en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_xpo_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
 ...
 * @returns {Boolean}
 */
if (typeof xpo_en_wd_edit_dropship != 'function')
{
    function xpo_en_wd_edit_dropship(e)
    {
        var postForm = {
            'action': 'xpo_en_wd_edit_dropship',
            'dropship_edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data)
            {
                if (data[0]) {
                    ...
                    xpo_load_inside_pikup_and_local_delivery_data(data, "#add_dropships");
                }
            },
        });
        return false;
 ...
 * @returns {Boolean}
 */
if (typeof en_xpo_wd_delete_current_dropship != 'function')
{
    function en_xpo_wd_delete_current_dropship(e)
    {
        var id = e;
...
if (typeof en_wd_confirm_delete_dropship != 'function')
{
    function en_wd_confirm_delete_dropship(e)
    {
        var tab = get_parameter_by_name('tab');
        var postForm = {
            'action': 'xpo_en_wd_delete_dropship',
