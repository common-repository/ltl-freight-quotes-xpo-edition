...
<script type="text/javascript">
    ...
    function xpo_en_wd_add_warehouse_btn()
    {
    ...
    function xpo_change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php xpo_warehouse_template(); ?>

    <!-- Add Popup for new warehouse -->
    <div id="xpo_en_wd_add_warehouse_btn" class="en_wd_warehouse_overlay">
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Zip"  maxlength="7" onchange="xpo_change_warehouse_zip()" value="" name="en_wd_origin_zip" placeholder="30214" id="en_wd_origin_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form" onclick="return xpo_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
