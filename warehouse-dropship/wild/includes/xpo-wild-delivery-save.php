...
if (!class_exists("XpoEnWooWdAddonsAjaxReqIncludes")) {

    class XpoEnWooWdAddonsAjaxReqIncludes
    {
        ...
        public function __construct()
        {
            ...
            add_action('wp_ajax_nopriv_xpo_en_wd_delete_dropship', array($this, 'xpo_delete_dropship_ajax'));
            add_action('wp_ajax_xpo_en_wd_delete_dropship', array($this, 'xpo_delete_dropship_ajax'));

            add_action('wp_ajax_nopriv_xpo_en_wd_save_warehouse', array($this, 'xpo_save_warehouse_ajax'));
            add_action('wp_ajax_xpo_en_wd_save_warehouse', array($this, 'xpo_save_warehouse_ajax'));

            add_action('wp_ajax_nopriv_xpo_en_wd_save_dropship', array($this, 'xpo_save_dropship_ajax'));
            add_action('wp_ajax_xpo_en_wd_save_dropship', array($this, 'xpo_save_dropship_ajax'));


            add_action('wp_ajax_nopriv_xpo_en_wd_edit_dropship', array($this, 'xpo_edit_dropship_ajax'));
            add_action('wp_ajax_xpo_en_wd_edit_dropship', array($this, 'xpo_edit_dropship_ajax'));

            add_action('wp_ajax_nopriv_xpo_en_wd_delete_warehouse', array($this, 'xpo_delete_warehouse_ajax'));
            add_action('wp_ajax_xpo_en_wd_delete_warehouse', array($this, 'xpo_delete_warehouse_ajax'));

            add_action('wp_ajax_nopriv_xpo_en_wd_edit_warehouse', array($this, 'xpo_edit_warehouse_ajax'));
            add_action('wp_ajax_xpo_en_wd_edit_warehouse', array($this, 'xpo_edit_warehouse_ajax'));
        }
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Get_sm_distance = new Get_xpo_freight_distance();
                $resp_json = $Get_sm_distance->xpo_freight_address($zipCode, $accessLevel);
         ...
         * @global $wpdb
         */
        function xpo_save_warehouse_ajax()
        {
            global $wpdb;
            $inputData = $_POST;
            $html = "";
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_warehouse_id && (empty($get_warehouse) || (!empty($get_warehouse) && reset($get_warehouse)->id == $get_warehouse_id))) {
                        ...
                        if (empty($get_warehouse)) {
                            ...
                            $html = xpo_warehouse_template(TRUE);
                        }
                    }
                }
         ...
         * @global $wpdb
         */
        function xpo_edit_warehouse_ajax()
        {
            global $wpdb;
         ...
         * @global $wpdb
         */
        function xpo_delete_warehouse_ajax()
        {
            global $wpdb;
         ...
         * @global $wpdb
         */
        function xpo_save_dropship_ajax()
        {
            global $wpdb;
            $inputData = $_POST;
            $html = "";
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_dropship_id != '' && (empty($get_dropship) || (!empty($get_dropship) && reset($get_dropship)->id == $get_dropship_id))) {
                        ...
                        if (empty($get_dropship)) {
                            ...
                            $html = xpo_dropship_template(TRUE);
                        }
                    }
                }
                $lastid = $wpdb->insert_id;
         ...
         * @global $wpdb
         */
        function xpo_edit_dropship_ajax()
        {
            global $wpdb;
         ...
         * @global $wpdb
         */
        function xpo_delete_dropship_ajax()
        {
            global $wpdb;
...
new XpoEnWooWdAddonsAjaxReqIncludes();