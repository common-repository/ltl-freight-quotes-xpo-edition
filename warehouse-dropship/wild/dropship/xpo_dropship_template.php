...
<script type="text/javascript">
    ...
    function xpo_change_dropship_zip() {
...
//      check current zipcode and test connection zipcode is same then hide the account field
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-xpo-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input title="Zip" type="text" maxlength="7" value="" onchange="xpo_change_dropship_zip()"
                    ...
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_dropship" value="Save" class="save_warehouse_form"
                               onclick="return xpo_en_wd_save_dropship();">
                    </div>
                </form>
            </div>
        </div>
