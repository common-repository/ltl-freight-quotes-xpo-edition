...
class EnXpoFdo
{
    ...
    public function en_cart_package($package)
    {
        ...
        $this->en_fdo_meta_data['plugin_name'] = 'xpo';
        $accessorials['residential'] = get_option('wc_settings_xpo_residential') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('wc_settings_xpo_liftgate') == 'yes' ? true : false;
