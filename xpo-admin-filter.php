...
/**
 * XPO WooComerce Admin Settings | Plugin Shipping Settings
...
/**
 * Add XPO Method In WOO Method List
 * @param $methods
 * @return string
 */
function add_xpo_logistics($methods)
{
    $methods['xpo'] = 'XPO_Logistics_Shipping';
    return $methods;
}

/**
 * Add Woo Setting Tab For XPO
 * @param $settings
 * @return array
 */
function xpo_shipping_sections($settings)
{
    include('xpo-tab-class.php');
    return $settings;
}
 ...
 * @return array
 */
function xpo_hide_shipping($available_methods)
{
    if (get_option('wc_settings_xpo_allow_other_plugins') == 'no'
 ...
 */
if (!function_exists("xpo_no_method_available")) {

    function xpo_no_method_available()
    {
