...
if (!class_exists("EnXPOFreightWDQuotes")) {

    class EnXPOFreightWDQuotes
    {

        public function __construct()
        {
            add_filter('en_xpo_freight_wd_update_query_string', array($this, 'en_xpo_freight_wd_update_query_string'), 10, 1);
            add_filter('en_xpo_freight_wd_origin_array_set', array($this, 'en_xpo_freight_wd_origin_array_set'), 10, 1);
            add_filter('en_xpo_freight_wd_standard_plans', array($this, 'en_xpo_freight_wd_standard_plans'), 10, 4);
        ...
        public function en_xpo_freight_wd_standard_plans($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
         ...
         * @return string
         */
        public function en_xpo_freight_wd_update_query_string()
        {
         ...
         * @return array type
         */
        public function en_xpo_freight_wd_origin_array_set($origin)
        {
            ...
            $xpo_account = (isset($origin->xpo_account)) ? $origin->xpo_account : "";
